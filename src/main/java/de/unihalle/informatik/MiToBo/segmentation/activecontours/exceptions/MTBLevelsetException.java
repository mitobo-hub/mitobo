 ...
 * @author moeller
 */
public class MTBLevelsetException extends MTBActiveContourException {
	 ...
	 */
	public MTBLevelsetException(
			MTBActiveContourException.ExceptionType t, String c) {
		super(t,c);
	}

	@Override
  public String getIdentString() {
		return "MTBLevelsetException";
	}
}
