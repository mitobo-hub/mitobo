...
- FeatureColorMapper: new option to configure image name suffix
...
### Changed
- MorphologyAnalyzer2D: some algorithmic changes to speed-up calculations
- PaCeQuant:
	- updated package structure
	- established internal infrastructure to support different segmentation algorithms
- Region2DSkeletonAnalyzer: some algorithmic changes to speed-up calculations
### Fixed
- PaCeQuant: fixed error in index calculation for segment mid-points
