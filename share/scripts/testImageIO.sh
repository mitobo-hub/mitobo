...
java -cp "$CP" de/unihalle/informatik/Alida/tools/ALDOpRunner ImageWriterMTB \
	fileName=copyOfscratch_example1.tif overwrite=true inputMTBImage=testimages/scratch_example1.tif
