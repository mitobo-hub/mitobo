...
public class ImgOpen extends MTBOperator {
	 ...
	 */
	@Override
	protected MTBImage myFunction() {
		ImgErode ero= new ImgErode();
		ero.setParameter("inImg", this.getInputImage());
		ero.setParameter("masksize", 3);
		ero.runOp(null);
		ImgDilate dil= new ImgDilate(ero.getResultImage(), 3);
		dil.runOp(null);
